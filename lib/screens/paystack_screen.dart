...
class _PaystackScreenState extends State<PaystackScreen> {
  ...
  onPaymentSuccess(paymentDetails) async{
    ...
    var paystackPaymentSuccessResponse = await PaymentRepository().getPaystackPaymentSuccessResponse(widget.payment_type, widget.amount,_order_id, paymentDetails);
