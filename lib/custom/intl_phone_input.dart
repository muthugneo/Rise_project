...
import 'package:rise_gfa/custom/input_decorations.dart';
...
class _InputWidgetState extends State<CustomInternationalPhoneNumberInput> {
  ...
  void initialiseWidget() async {
    bool? check=await PhoneNumberUtil.isValidNumber(
  ...
  String? validator(String value) {
    ...
    return isValid ? widget.errorMessage : "";
  }
          ...
          Column(
            ...
            children: <Widget>[
              CustomSelectorButton(
                ...
                selectorConfig: widget.selectorConfig!,
                selectorTextStyle: widget.selectorTextStyle!,
                searchBoxDecoration: widget.searchBoxDecoration?? InputDecoration(),
                locale: state.locale??"",
                isEnabled: widget.isEnabled!,
                autoFocusSearchField: widget.autoFocusSearch!,
                isScrollControlled: widget.countrySelectorScrollControlled!,
